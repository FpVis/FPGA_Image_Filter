...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { background_sel  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
#set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { background_sel[1]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
...
#set_property -dict { PACKAGE_PIN U2  IOSTANDARD LVCMOS33 } [get_ports { an[0]  }]; #IO_L9N_T1_DQS_34   ,Sch=an[0]
#set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { an[1]  }]; #IO_L11P_T1_SRCC_34 ,Sch=an[1]
#set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports { an[2]  }]; #IO_L11N_T1_SRCC_34 ,Sch=an[2]
#set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports { an[3]  }]; #IO_L12N_T1_MRCC_34 ,Sch=an[3]
...
#set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { start }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
...
set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports {ov7670_data_back[0] }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
set_property -dict { PACKAGE_PIN L2  IOSTANDARD LVCMOS33 } [get_ports {ov7670_data_back[2] }]; #IO_L5N_T0_AD13N_35    ,Sch=JA2
set_property -dict { PACKAGE_PIN J2  IOSTANDARD LVCMOS33 } [get_ports {ov7670_data_back[4] }]; #IO_L2N_T0_AD12N_35    ,Sch=JA3
set_property -dict { PACKAGE_PIN G2  IOSTANDARD LVCMOS33 } [get_ports {ov7670_data_back[6] }]; #IO_L1N_T0_AD4N_35     ,Sch=JA4
set_property -dict { PACKAGE_PIN H1  IOSTANDARD LVCMOS33 } [get_ports {ov7670_data_back[1] }]; #IO_L3P_T0_DQS_AD5P_35 ,Sch=JA7
set_property -dict { PACKAGE_PIN K2  IOSTANDARD LVCMOS33 } [get_ports {ov7670_data_back[3] }]; #IO_L5P_T0_AD13P_35    ,Sch=JA8
set_property -dict { PACKAGE_PIN H2  IOSTANDARD LVCMOS33 } [get_ports {ov7670_data_back[5] }]; #IO_L2P_T0_AD12P_35    ,Sch=JA9
set_property -dict { PACKAGE_PIN G3  IOSTANDARD LVCMOS33 } [get_ports {ov7670_data_back[7] }]; #IO_L1P_T0_AD4P_35     ,Sch=JA10
...
set_property -dict { PACKAGE_PIN B15  IOSTANDARD LVCMOS33 } [get_ports { ov7670_v_sync_back }]; #IO_L11N_T1_SRCC_16 ,Sch=JB3
set_property -dict { PACKAGE_PIN B16  IOSTANDARD LVCMOS33 } [get_ports { scl_back }]; #IO_L13N_T2_MRCC_16 ,Sch=JB4
...
set_property -dict { PACKAGE_PIN C15  IOSTANDARD LVCMOS33 } [get_ports { ov7670_href_back }]; #IO_L11P_T1_SRCC_16 ,Sch=JB9
set_property -dict { PACKAGE_PIN C16  IOSTANDARD LVCMOS33 } [get_ports { sda_back }]; #IO_L13P_T2_MRCC_16 ,Sch=JB10
...
set_property -dict { PACKAGE_PIN N17  IOSTANDARD LVCMOS33 } [get_ports { ov7670_pclk_back }]; #IO_L13P_T2_MRCC_14 ,Sch=JC3
set_property -dict { PACKAGE_PIN P18  IOSTANDARD LVCMOS33 } [get_ports { sda }]; #IO_L14P_T2_SRCC_14 ,Sch=JC4
...
set_property -dict { PACKAGE_PIN P17  IOSTANDARD LVCMOS33 } [get_ports { ov7670_xclk_back }]; #IO_L13N_T2_MRCC_14 ,Sch=JC9
set_property -dict { PACKAGE_PIN R18  IOSTANDARD LVCMOS33 } [get_ports { scl }]; #IO_L14N_T2_SRCC_14 ,Sch=JC10


##Pmod Header JXADC

set_property -dict { PACKAGE_PIN J3  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[4] }]; #IO_L7P_T1_AD6P_35     ,Sch=XA1_P
set_property -dict { PACKAGE_PIN L3  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[6] }]; #IO_L7N_T1_AD6N_35     ,Sch=XA2_P
set_property -dict { PACKAGE_PIN M2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[5] }]; #IO_L8P_T1_AD14P_35    ,Sch=XA3_P
set_property -dict { PACKAGE_PIN N2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[7] }]; #IO_L8N_T1_AD14N_35    ,Sch=XA4_P
#set_property -dict { PACKAGE_PIN K3  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[5] }]; #IO_L9P_T1_DQS_AD7P_35 ,Sch=XA1_N
#set_property -dict { PACKAGE_PIN M3  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data[7] }]; #IO_L9N_T1_DQS_AD7N_35 ,Sch=XA2_N
#set_property -dict { PACKAGE_PIN M1  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data_back[5] }]; #IO_L10P_T1_AD15P_35   ,Sch=XA3_N
#set_property -dict { PACKAGE_PIN N1  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data_back[7] }]; #IO_L10N_T1_AD15N_35   ,Sch=XA4_N


##VGA Connector

set_property -dict { PACKAGE_PIN G19  IOSTANDARD LVCMOS33 } [get_ports { red_port[0]   }]; #IO_L4N_T0_D05_14      ,Sch=VGA_R0
set_property -dict { PACKAGE_PIN H19  IOSTANDARD LVCMOS33 } [get_ports { red_port[1]   }]; #IO_L4P_T0_D04_14      ,Sch=VGA_R1
set_property -dict { PACKAGE_PIN J19  IOSTANDARD LVCMOS33 } [get_ports { red_port[2]   }]; #IO_L6N_T0_D08_VREF_14 ,Sch=VGA_R2
set_property -dict { PACKAGE_PIN N19  IOSTANDARD LVCMOS33 } [get_ports { red_port[3]   }]; #IO_L9N_T1_DQS_D13_14  ,Sch=VGA_R3
set_property -dict { PACKAGE_PIN N18  IOSTANDARD LVCMOS33 } [get_ports { blue_port[0]  }]; #IO_L9P_T1_DQS_14      ,Sch=VGA_B0
set_property -dict { PACKAGE_PIN L18  IOSTANDARD LVCMOS33 } [get_ports { blue_port[1]  }]; #IO_L8P_T1_D11_14      ,Sch=VGA_B1
set_property -dict { PACKAGE_PIN K18  IOSTANDARD LVCMOS33 } [get_ports { blue_port[2]  }]; #IO_L8N_T1_D12_14      ,Sch=VGA_B2
set_property -dict { PACKAGE_PIN J18  IOSTANDARD LVCMOS33 } [get_ports { blue_port[3]  }]; #IO_L7N_T1_D10_14      ,Sch=VGA_B3
set_property -dict { PACKAGE_PIN J17  IOSTANDARD LVCMOS33 } [get_ports { green_port[0] }]; #IO_L7P_T1_D09_14      ,Sch=VGA_G0
set_property -dict { PACKAGE_PIN H17  IOSTANDARD LVCMOS33 } [get_ports { green_port[1] }]; #IO_L5P_T0_D06_14      ,Sch=VGA_G1
set_property -dict { PACKAGE_PIN G17  IOSTANDARD LVCMOS33 } [get_ports { green_port[2] }]; #IO_L5N_T0_D07_14      ,Sch=VGA_G2
set_property -dict { PACKAGE_PIN D17  IOSTANDARD LVCMOS33 } [get_ports { green_port[3] }]; #IO_0_14               ,Sch=VGA_G3
set_property -dict { PACKAGE_PIN P19  IOSTANDARD LVCMOS33 } [get_ports { h_sync       }]; #IO_L10P_T1_D14_14     ,Sch=VGA_HS
set_property -dict { PACKAGE_PIN R19  IOSTANDARD LVCMOS33 } [get_ports { v_sync       }]; #IO_L10N_T1_D15_14     ,Sch=VGA_VS
