...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { gray_sw  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
...
set_property -dict { PACKAGE_PIN G2  IOSTANDARD LVCMOS33 } [get_ports { scl2 }]; #IO_L1N_T0_AD4N_35     ,Sch=JA4
...
set_property -dict { PACKAGE_PIN G3  IOSTANDARD LVCMOS33 } [get_ports { sda2 }]; #IO_L1P_T0_AD4P_35     ,Sch=JA10


##Pmod Header JB

set_property -dict { PACKAGE_PIN A14  IOSTANDARD LVCMOS33 } [get_ports { scl1 }]; #IO_L6P_T0_16       ,Sch=JB1
...
set_property -dict { PACKAGE_PIN A15  IOSTANDARD LVCMOS33 } [get_ports { sda1 }]; #IO_L6N_T0_VREF_16  ,Sch=JB7
...
set_property -dict { PACKAGE_PIN K17  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data1[6] }]; #IO_L12N_T1_MRCC_14 ,Sch=JC1
set_property -dict { PACKAGE_PIN M18  IOSTANDARD LVCMOS33 } [get_ports { ov7670_xclk1 }]; #IO_L11P_T1_SRCC_14 ,Sch=JC2
set_property -dict { PACKAGE_PIN N17  IOSTANDARD LVCMOS33 } [get_ports { ov7670_pclk2 }]; #IO_L13P_T2_MRCC_14 ,Sch=JC3
# set_property -dict { PACKAGE_PIN P18  IOSTANDARD LVCMOS33 } [get_ports { JC[3] }]; #IO_L14P_T2_SRCC_14 ,Sch=JC4
set_property -dict { PACKAGE_PIN L17  IOSTANDARD LVCMOS33 } [get_ports { ov7670_pclk1 }]; #IO_L12P_T1_MRCC_14 ,Sch=JC7
set_property -dict { PACKAGE_PIN M19  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data1[7] }]; #IO_L11N_T1_SRCC_14 ,Sch=JC8
set_property -dict { PACKAGE_PIN P17  IOSTANDARD LVCMOS33 } [get_ports { ov7670_v_sync1 }]; #IO_L13N_T2_MRCC_14 ,Sch=JC9
...
set_property -dict { PACKAGE_PIN L3  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[0] }]; #IO_L7N_T1_AD6N_35     ,Sch=XA2_P
set_property -dict { PACKAGE_PIN M2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[2] }]; #IO_L8P_T1_AD14P_35    ,Sch=XA3_P
set_property -dict { PACKAGE_PIN N2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[4] }]; #IO_L8N_T1_AD14N_35    ,Sch=XA4_P
#set_property -dict { PACKAGE_PIN K3  IOSTANDARD LVCMOS33 } [get_ports { JXADC[4] }]; #IO_L9P_T1_DQS_AD7P_35 ,Sch=XA1_N
set_property -dict { PACKAGE_PIN M3  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[1] }]; #IO_L9N_T1_DQS_AD7N_35 ,Sch=XA2_N
set_property -dict { PACKAGE_PIN M1  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[3] }]; #IO_L10P_T1_AD15P_35   ,Sch=XA3_N
set_property -dict { PACKAGE_PIN N1  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[5] }]; #IO_L10N_T1_AD15N_35   ,Sch=XA4_N
